...
import AgentDialogue, { DialogueMessage } from './AgentDialogue'
  ...
  return (
    <div>
      ...
      <AgentDialogue
        ...
        isExpanded={isDialogueExpanded}
        onToggleExpand={onToggleDialogue}
        isLive={agent.status === 'active' || agent.status === 'processing'}
      />
    </div>
  )
}